(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".images-work-page__slider")) new core(".images-work-page__slider", {
        ...
        if (document.querySelector(".similars-work__slider")) new core(".similars-work__slider", {
            modules: [ Navigation, Autoplay, Pagination ],
            observer: true,
            observeParents: true,
            spaceBetween: 30,
